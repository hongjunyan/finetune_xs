...
from data_process import load_dataset as customized_load_datasets
import transformers
...
class DataTrainingArguments:
    ...
    def __post_init__(self):
        if self.context_length > 1024:
            raise ValueError("context length must smaller than 1024")
...
def main():
    ...
    if data_args.dataset_name == "xscript":
        datasets = customized_load_datasets()
